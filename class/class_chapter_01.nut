...
class tutorial.chapter_01 extends basic_chapter
{
  ...
  function set_goal_text(text) {
    switch ( this.step ) {
      ...
      break;
      case 3:
        text.pos = "<a href=\"(" + city1_mon.tostring() + ")\">" + buil1_name + " (" + city1_mon.tostring() + ")</a>"
        text.buld_name = "<a href=\"(" + city1_cur.tostring() + ")\">" + buil2_name + " (" + city1_cur.tostring() + ")</a>"
      break;
      case 4:
        text.pos2 = "<a href=\"(" + city1_tow.tostring() + ")\">" + translate(ch1_text5) + " (" + city1_tow.tostring() + ")</a>"
      break;
